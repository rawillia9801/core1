              ...
              {puppies.map((row) => {
                ...
                return (
                  <article key={row.id} className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                    ...
                    <div className="mt-5 flex flex-wrap gap-2"><Link href={`/staff/puppies/${row.id}/edit`} className="rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-semibold">Edit</Link></div>
